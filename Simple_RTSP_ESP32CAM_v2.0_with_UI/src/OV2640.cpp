...
camera_config_t esp32cam_aithinker_config{
    ...
    .pin_href = 23,
    .pin_pclk = 22,
    .xclk_freq_hz = 20000000,           // XCLK 20 MHz untuk FPS cepat
    .ledc_timer = LEDC_TIMER_1,
    .ledc_channel = LEDC_CHANNEL_1,
    .pixel_format = PIXFORMAT_JPEG,     // wajib JPEG untuk stream cepat
    // .frame_size = FRAMESIZE_UXGA, // needs 234K of framebuffer space
    // .frame_size = FRAMESIZE_SXGA, // needs 160K for framebuffer
    // .frame_size = FRAMESIZE_XGA, // needs 96K or even smaller FRAMESIZE_SVGA - can work if using only 1 fb
    .frame_size = FRAMESIZE_QVGA,       // resolusi optimal untuk FPS tinggi
    .jpeg_quality = 12,                 // 10-15 recommended
    .fb_count = 2,                      // double buffer (FPS naik)
    .grab_mode = CAMERA_GRAB_LATEST     // hindari buffering delay
};
